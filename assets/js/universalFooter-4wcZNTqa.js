const k="/apap_template/";async function C(){try{const r="mapConfig_apap_template",t=localStorage.getItem(r);if(t)return console.log(`Loading configuration from localStorage (${r})`),JSON.parse(t);const o=await(await fetch(`${k}config/map-config.json`)).json();return console.log("Loaded configuration from server:",o),o}catch(r){throw console.error("Error loading configuration:",r),r}}async function $(r){try{const t="mapConfig_apap_template";return localStorage.setItem(t,JSON.stringify(r,null,2)),console.log(`✅ Configuration saved to ${t}`),!0}catch(t){return console.error("Error saving configuration:",t),!1}}const w=/^[A-Za-z]:\//;function f(r=""){return r&&r.replace(/\\/g,"/").replace(w,t=>t.toUpperCase())}const y=/^[/\\]{2}/,E=/^[/\\](?![/\\])|^[/\\]{2}(?!\.)|^[A-Za-z]:[/\\]/,m=/^[A-Za-z]:$/,S=function(r){if(r.length===0)return".";r=f(r);const t=r.match(y),e=g(r),o=r[r.length-1]==="/";return r=L(r,!e),r.length===0?e?"/":o?"./":".":(o&&(r+="/"),m.test(r)&&(r+="/"),t?e?`//${r}`:`//./${r}`:e&&!g(r)?`/${r}`:r)},v=function(...r){let t="";for(const e of r)if(e)if(t.length>0){const o=t[t.length-1]==="/",s=e[0]==="/";o&&s?t+=e.slice(1):t+=o||s?e:`/${e}`}else t+=e;return S(t)};function L(r,t){let e="",o=0,s=-1,i=0,n=null;for(let a=0;a<=r.length;++a){if(a<r.length)n=r[a];else{if(n==="/")break;n="/"}if(n==="/"){if(!(s===a-1||i===1))if(i===2){if(e.length<2||o!==2||e[e.length-1]!=="."||e[e.length-2]!=="."){if(e.length>2){const c=e.lastIndexOf("/");c===-1?(e="",o=0):(e=e.slice(0,c),o=e.length-1-e.lastIndexOf("/")),s=a,i=0;continue}else if(e.length>0){e="",o=0,s=a,i=0;continue}}t&&(e+=e.length>0?"/..":"..",o=2)}else e.length>0?e+=`/${r.slice(s+1,a)}`:e=r.slice(s+1,a),o=a-s-1;s=a,i=0}else n==="."&&i!==-1?++i:i=-1}return e}const g=function(r){return E.test(r)},P=function(r){const t=f(r).replace(/\/$/,"").split("/").slice(0,-1);return t.length===1&&m.test(t[0])&&(t[0]+="/"),t.join("/")||(g(r)?"/":".")},p=function(r,t){const e=f(r).split("/");let o="";for(let s=e.length-1;s>=0;s--){const i=e[s];if(i){o=i;break}}return t&&o.endsWith(t)?o.slice(0,-t.length):o};class T{constructor(t){this.viteBasePath="/apap_template/",this.currentPath=this.normalizePath(window.location.pathname),this.config=t,this.basePath=this.calculateBasePath(this.config),this.header=null,this.isScrolling=!1,this.scrollThreshold=100,console.log("Vite BASE_URL:",this.viteBasePath),console.log("Current Path:",this.currentPath),console.log("Calculated Base Path:",this.basePath)}normalizePath(t){return t.endsWith("/")?t+"index.html":!t.includes(".")&&!t.endsWith("/")?t+"/index.html":t}calculateBasePath(t){let e=this.currentPath;this.viteBasePath!=="/"&&e.startsWith(this.viteBasePath)&&(e=e.substring(this.viteBasePath.length));const o=P(e);if(o==="/"||o===""||o===".")return this.viteBasePath;const s=o.split("/").filter(n=>n).length;return"../".repeat(s)+this.viteBasePath.replace(/^\//,"")}getRelativePath(t){return this.basePath.startsWith("/")?v(this.basePath,t).replace(/\/+/g,"/"):v(this.basePath,t)}render(){const t=this.createNavElement(),e=[{text:"Home",path:"index.html"},{text:"Mappa",path:"pages/mappa.html"},{text:"Indici",path:"pages/indici.html"},{text:"Percorsi critici",path:"pages/percorsi.html"}],o=this.generateNavHTML(e);return t.innerHTML=o,this.setupEventListeners(),this.setupScrollListener(),console.log("Navigation rendered - Links:",{home:this.getRelativePath("index.html"),mappa:this.getRelativePath("pages/mappa.html")}),t}generateLogoHTML(){var e,o;const t=(o=(e=this.config)==null?void 0:e.project)==null?void 0:o.projectThumbnailURL;if(t&&t.trim()!==""){const s=t.startsWith("imgs/")?this.getRelativePath(t):this.getRelativePath(`imgs/${t}`);return`
            ...
            `}generateNavHTML(t){const e=t.map(s=>{const i=this.getRelativePath(s.path),a=this.isActivePath(s.path)?"text-primary-900 border-b-2 border-primary-600 pb-1":"text-gray-600 hover:text-primary-600",c=s.section?`data-section="${s.section}"`:"";return`<a href="${i}" class="nav-link ${a} font-medium transition duration-200" ${c}>${s.text}</a>`}).join(""),o=t.map(s=>{const i=this.getRelativePath(s.path),a=this.isActivePath(s.path)?"text-primary-900 bg-primary-50 font-medium":"text-gray-600 hover:text-primary-600 hover:bg-gray-50",c=s.section?`data-section="${s.section}"`:"";return`<a href="${i}" class="block px-4 py-3 ${a} transition duration-200" ${c}>${s.text}</a>`}).join("");return`
        ...
        `,document.body.appendChild(e),e}generateCompactFooterHTML(){var i,n,a,c;const t=new Date().getFullYear();(n=(i=this.config)==null?void 0:i.project)!=null&&n.projectTitle;const e=((c=(a=this.config)==null?void 0:a.project)==null?void 0:c.projectShortTitle)||"SASSI",o=this.getNavigationLinks().map(l=>{const h=this.isExternalLink(l.path),d=h?l.path:this.getRelativePath(l.path),u=l.section?`data-section="${l.section}"`:"",x=h?'target="_blank" rel="noopener noreferrer"':"",b=h?`
            ...
            `:"";return`<li><a href="${d}" ${x} ${u}>${l.text}${b}</a></li>`}).join("");let s="";if(this.logos.length>0){const l=this.logos.map(d=>`
